...
from google.cloud.bare_metal_solution_v2.services.bare_metal_solution import BareMetalSolutionAsyncClient
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,use_client_cert_env", [
    ...
    (BareMetalSolutionClient, transports.BareMetalSolutionRestTransport, "rest", "true"),
    (BareMetalSolutionClient, transports.BareMetalSolutionRestTransport, "rest", "false"),
])
@mock.patch.object(BareMetalSolutionClient, "DEFAULT_ENDPOINT", modify_default_endpoint(BareMetalSolutionClient))
@mock.patch.object(BareMetalSolutionAsyncClient, "DEFAULT_ENDPOINT", modify_default_endpoint(BareMetalSolutionAsyncClient))
...
@pytest.mark.parametrize("client_class", [
    BareMetalSolutionClient, BareMetalSolutionAsyncClient
])
@mock.patch.object(BareMetalSolutionClient, "DEFAULT_ENDPOINT", modify_default_endpoint(BareMetalSolutionClient))
@mock.patch.object(BareMetalSolutionAsyncClient, "DEFAULT_ENDPOINT", modify_default_endpoint(BareMetalSolutionAsyncClient))
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,grpc_helpers", [
    (BareMetalSolutionClient, transports.BareMetalSolutionGrpcTransport, "grpc", grpc_helpers),
    (BareMetalSolutionAsyncClient, transports.BareMetalSolutionGrpcAsyncIOTransport, "grpc_asyncio", grpc_helpers_async),
    (BareMetalSolutionClient, transports.BareMetalSolutionRestTransport, "rest", None),
])
...
def test_detach_lun(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.detach_lun),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
async def test_list_volumes_async_pages():
    ...
    with mock.patch.object(
        ...
        pages = []
        async for page_ in (await client.list_volumes(request={})).pages: # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ['abc','def','ghi', '']):
            assert page_.raw_page.next_page_token == token
...
def test_resize_volume(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.resize_volume),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_list_networks_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, network.Network)
                   for i in results)
...
async def test_list_networks_async_pages():
    ...
    with mock.patch.object(
        ...
        pages = []
        async for page_ in (await client.list_networks(request={})).pages: # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ['abc','def','ghi', '']):
            assert page_.raw_page.next_page_token == token
...
def test_list_network_usage(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.list_network_usage),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_update_network(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.update_network),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_list_luns_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, lun.Lun)
                   for i in results)
...
async def test_list_luns_async_pages():
    ...
    with mock.patch.object(
        ...
        pages = []
        async for page_ in (await client.list_luns(request={})).pages: # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ['abc','def','ghi', '']):
            assert page_.raw_page.next_page_token == token
...
def test_get_nfs_share(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_nfs_share),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_list_nfs_shares(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.list_nfs_shares),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_list_nfs_shares_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, nfs_share.NfsShare)
                   for i in results)
...
async def test_list_nfs_shares_async_pages():
    ...
    with mock.patch.object(
        ...
        pages = []
        async for page_ in (await client.list_nfs_shares(request={})).pages: # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ['abc','def','ghi', '']):
            assert page_.raw_page.next_page_token == token
...
def test_update_nfs_share(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.update_nfs_share),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_list_instances_rest_interceptors(null_interceptor):
    transport = transports.BareMetalSolutionRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.BareMetalSolutionRestInterceptor(),
        )
    client = BareMetalSolutionClient(transport=transport)
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.BareMetalSolutionRestInterceptor, "post_list_instances") as post, \
         mock.patch.object(transports.BareMetalSolutionRestInterceptor, "pre_list_instances") as pre:
...
def test_get_instance_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.BareMetalSolutionRestInterceptor, "post_get_instance") as post, \
         mock.patch.object(transports.BareMetalSolutionRestInterceptor, "pre_get_instance") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_update_instance_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         ...
         mock.patch.object(transports.BareMetalSolutionRestInterceptor, "post_update_instance") as post, \
         mock.patch.object(transports.BareMetalSolutionRestInterceptor, "pre_update_instance") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_reset_instance_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.BareMetalSolutionRestInterceptor, "post_reset_instance") as post, \
         mock.patch.object(transports.BareMetalSolutionRestInterceptor, "pre_reset_instance") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_start_instance_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.BareMetalSolutionRestInterceptor, "post_start_instance") as post, \
         mock.patch.object(transports.BareMetalSolutionRestInterceptor, "pre_start_instance") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_stop_instance_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.BareMetalSolutionRestInterceptor, "post_stop_instance") as post, \
         mock.patch.object(transports.BareMetalSolutionRestInterceptor, "pre_stop_instance") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_detach_lun_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.BareMetalSolutionRestInterceptor, "post_detach_lun") as post, \
         mock.patch.object(transports.BareMetalSolutionRestInterceptor, "pre_detach_lun") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_list_volumes_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.BareMetalSolutionRestInterceptor, "post_list_volumes") as post, \
         mock.patch.object(transports.BareMetalSolutionRestInterceptor, "pre_list_volumes") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_get_volume_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.BareMetalSolutionRestInterceptor, "post_get_volume") as post, \
         mock.patch.object(transports.BareMetalSolutionRestInterceptor, "pre_get_volume") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_update_volume_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.BareMetalSolutionRestInterceptor, "post_update_volume") as post, \
         mock.patch.object(transports.BareMetalSolutionRestInterceptor, "pre_update_volume") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_resize_volume_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.BareMetalSolutionRestInterceptor, "post_resize_volume") as post, \
         mock.patch.object(transports.BareMetalSolutionRestInterceptor, "pre_resize_volume") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_list_networks_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.BareMetalSolutionRestInterceptor, "post_list_networks") as post, \
         mock.patch.object(transports.BareMetalSolutionRestInterceptor, "pre_list_networks") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_list_network_usage_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.BareMetalSolutionRestInterceptor, "post_list_network_usage") as post, \
         mock.patch.object(transports.BareMetalSolutionRestInterceptor, "pre_list_network_usage") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_get_network_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.BareMetalSolutionRestInterceptor, "post_get_network") as post, \
         mock.patch.object(transports.BareMetalSolutionRestInterceptor, "pre_get_network") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_update_network_rest(request_type):
    ...
    request_init["network"] = {'name': 'projects/sample1/locations/sample2/networks/sample3', 'id': 'id_value', 'type_': 1, 'ip_address': 'ip_address_value', 'mac_address': ['mac_address_value1', 'mac_address_value2'], 'state': 1, 'vlan_id': 'vlan_id_value', 'cidr': 'cidr_value', 'vrf': {'name': 'name_value', 'state': 1, 'qos_policy': {'bandwidth_gbps': 0.1472}, 'vlan_attachments': [{'peer_vlan_id': 1256, 'peer_ip': 'peer_ip_value', 'router_ip': 'router_ip_value'}]}, 'labels': {}, 'services_cidr': 'services_cidr_value', 'reservations': [{'start_address': 'start_address_value', 'end_address': 'end_address_value', 'note': 'note_value'}]}
    request = request_type(**request_init)
...
def test_update_network_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.BareMetalSolutionRestInterceptor, "post_update_network") as post, \
         mock.patch.object(transports.BareMetalSolutionRestInterceptor, "pre_update_network") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_get_lun_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.BareMetalSolutionRestInterceptor, "post_get_lun") as post, \
         mock.patch.object(transports.BareMetalSolutionRestInterceptor, "pre_get_lun") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_list_luns_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.BareMetalSolutionRestInterceptor, "post_list_luns") as post, \
         mock.patch.object(transports.BareMetalSolutionRestInterceptor, "pre_list_luns") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_get_nfs_share_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.BareMetalSolutionRestInterceptor, "post_get_nfs_share") as post, \
         mock.patch.object(transports.BareMetalSolutionRestInterceptor, "pre_get_nfs_share") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_list_nfs_shares_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.BareMetalSolutionRestInterceptor, "post_list_nfs_shares") as post, \
         mock.patch.object(transports.BareMetalSolutionRestInterceptor, "pre_list_nfs_shares") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_update_nfs_share_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.BareMetalSolutionRestInterceptor, "post_update_nfs_share") as post, \
         mock.patch.object(transports.BareMetalSolutionRestInterceptor, "pre_update_nfs_share") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
@pytest.mark.parametrize("client_class,transport_class", [
    ...
    (BareMetalSolutionAsyncClient, transports.BareMetalSolutionGrpcAsyncIOTransport),
])
